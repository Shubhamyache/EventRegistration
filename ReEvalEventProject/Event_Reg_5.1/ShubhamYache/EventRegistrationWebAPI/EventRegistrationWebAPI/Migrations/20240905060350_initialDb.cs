        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatinumTicketsNumber = table.Column<int>(type: "int", nullable: false),
                    PlatinumTicketsPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    GoldTicketsNumber = table.Column<int>(type: "int", nullable: false),
                    GoldTicketsPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SilverTicketsNumber = table.Column<int>(type: "int", nullable: false),
                    SilverTicketsPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatinumTicketsCount = table.Column<int>(type: "int", nullable: false),
                    GoldTicketsCount = table.Column<int>(type: "int", nullable: false),
                    SilverTicketsCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registration_RegistrationId",
                table: "Registrations",
                column: "RegistrationId");
